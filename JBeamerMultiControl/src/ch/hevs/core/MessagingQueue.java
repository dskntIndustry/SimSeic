...
public class MessagingQueue implements Runnable
{
	...
	/**
	 * Util method used to find a specific socket into the synchronized list
	 * according to its identifier e.g ip address
	 * 
	 * @author Mikael Follonier mikael.follonier@hevs.ch
	 * 
	 * @param s
	...
	/**
	 * The run() method is implemented from Runnable interface. It checks the
	 * message queue and dispatch the message to the queue present in each
	 * ThreadedSocket object.
	 * 
	 * @author Mikael Follonier mikael.follonier@hevs.ch
	 * 
	 */
